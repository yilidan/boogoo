	...
	var vm = new Vue({
	    ...
	    methods: {
	        ...
	        edit: function edit(item) {
	            localStorage.setItem("editSite", (0, _stringify2.default)(item));
	            var data = (0, _stringify2.default)({
	                url: _global2.default.path + "/page/EditSite.html"
	            });
	            location.href = "boogoo.app://?pushcode=100002&data=" + data;
	        },
	        deletes: function deletes(addressid) {
	            var _this2 = this;

	            _axios2.default.get(_global2.default.Apipath + "/api/Product/EditAddress", {
	                params: {
	                    token: token,
	                    userid: userid,
	                    type: 2,
	                ...
	                if (data.code == 1000) {
	                    ...
	                    _global2.default.toast(_this2, "删除成功");

	                    _this2.getdata();
	                } else {
	                    _global2.default.toast(_this2, "删除失败");
	                }
	            }, function (err) {
	        ...
	        addsite: function addsite() {
	            var data = (0, _stringify2.default)({
	                url: _global2.default.path + "/page/AddSite.html"
	            });
	            location.href = "boogoo.app://?pushcode=100002&data=" + data;
	        },
	        getdata: function getdata() {
	            ...
	            _axios2.default.get(_global2.default.Apipath + "/api/Product/AddressInfo", {
	                params: {
	                    token: token,
	                    userid: userid
	                }
	                ...
	                _this3.sitelist = data;
	                data.forEach(function (element, index) {

	                    if (element.state == 1) {

	                        _this3.activeindex = index; //设置默认地址
	                    }
	                });
	            }, function (err) {
	        ...
	        setDefault: function setDefault(indexOfItem, addressid) {
	            var _this4 = this;
	            ...
	            _axios2.default.get(_global2.default.Apipath + "/api/Product/EditAddress", {
	                ...
	                var data = req.data;
	                if (data.code == 1000) {
	                    _global2.default.toast(_this4, "设置成功");
	                    _this4.activeindex = indexOfItem;
	                } else {
	                    _global2.default.toast(_this4, "设置失败");
	                }
	            }, function (err) {
	                alert("EditAddress err");
	            });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./ManageSite.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./ManageSite.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
