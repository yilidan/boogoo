...
/***/ (function(module, exports, __webpack_require__) {
	...
	var higheruserid = _global2.default.getQueryString("userid") ? _global2.default.getQueryString("userid") : "";
	    ...
	    methods: {
	        ...
	        queryShareData: function queryShareData() {
	            ...
	            _axios2.default.get(_global2.default.Apipath + "/api/user/GetAppConfig").then(function (res) {
	                _this2.shareData = res.data.data.ShareGiftShare;
	                console.log(_this2.shareData);
	            }, function (err) {
	        ...
	        shareBtn: function shareBtn() {
	            ...
	            var data = (0, _stringify2.default)({
	                ...
	                url: _global2.default.path + "/share/register.html",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./Share.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./Share.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
