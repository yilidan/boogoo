	...
	var vm = new Vue({
	    ...
	    mounted: function mounted() {
	        this.$nextTick(function () {
	            ...
	            var bannerH = (0, _jquery2.default)(".banner").height();
	            bannerH = searchH + parseInt(bannerH);
	            (0, _jquery2.default)(".banner").css({
	                "margin-top": searchH
	            });
	            (0, _jquery2.default)(".goods").css({
	                "top": bannerH
	            });
	        });
	    },
	    methods: {
	        ...
	        queryGoodsClass: function queryGoodsClass() {
	            var _this2 = this;

	            _axios2.default.get(_global2.default.Apipath + "/api/Product/HomePage").then(function (req) {
	                var data = req.data;
	                _this2.goodsList = data.classlist;
	                console.log(_this2.goodsList);
	                _this2.goodsList.forEach(function (item, index) {
	                    if (item.classid == '1') {
	                        return _this2.goodsList.splice(index, 1);
	                    } else if (item.classid == '2') {
	                        return _this2.goodsList.splice(index, 1);
	                    }
	                });
	                _this2.currentClassid = _this2.goodsList[0].classid;
	                _this2.queryGoodsDetails(_this2.currentClassid);
	                console.log(_this2.goodsList);
	            });
	        },
	        selectMenu: function selectMenu(index, classid) {
	            this.currentIndex = index;
	            this.queryGoodsDetails(classid);
	            console.log(classid);
	        },
	        queryGoodsDetails: function queryGoodsDetails(classid) {
	            var _this3 = this;

	            _axios2.default.get(_global2.default.Apipath + "/api/Product/ProductCategoryGroupList", {
	                params: {
	                    classid: classid
	                }
	            }).then(function (res) {
	                _this3.goodsDetails = res.data.data;
	                console.log(_this3.goodsDetails);
	            });
	        },
	        gotoClassifyList: function gotoClassifyList(item) {
	            if (item.parentid == "-1") {
	                var data = (0, _stringify2.default)({
	                    url: _global2.default.path + "/page/ClassifyList.html?classifyid=" + item.classid + "&brandid=" + item.searchid
	                });
	                ...
	                var data = (0, _stringify2.default)({
	                    url: _global2.default.path + "/page/ClassifyList.html?classifyid=" + item.classid + "&categoryid=" + item.searchid
	                });
	                location.href = "boogoo.app://?pushcode=100011&data=" + data;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./GoodsClass.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./GoodsClass.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html {\n  font-family: \"Microsoft Yahei\"; }\n\n.banner {\n  width: 100%;\n  height: 4rem;\n  margin-top: 1.17333rem; }\n\n.banner img {\n  width: 100%;\n  height: 4rem;\n  vertical-align: middle; }\n\n.mint-swipe-indicator {\n  width: 0.16rem;\n  height: 0.16rem; }\n\n.mint-swipe-indicator.is-active {\n  background-color: #ED4F02;\n  opacity: .8; }\n\n.goods {\n  display: flex;\n  display: -webkit-flex;\n  /* Safari */\n  position: absolute;\n  top: 5.17333rem;\n  bottom: 0;\n  width: 100%;\n  background-color: #E9E9E9;\n  overflow: hidden;\n  margin-top: 0.13333rem; }\n  .goods .menu-wrapper {\n    overflow: auto;\n    -webkit-overflow-scrolling: touch;\n    background-color: #fff; }\n    .goods .menu-wrapper .menu-item {\n      display: table;\n      width: 2.66667rem;\n      height: 1.30667rem;\n      line-height: 1.30667rem;\n      text-align: center;\n      border-bottom: 1px solid #A7A7A7; }\n      .goods .menu-wrapper .menu-item.current {\n        margin-top: -1px;\n        background-color: #E9E9E9;\n        border-right: none; }\n      .goods .menu-wrapper .menu-item .text {\n        font-size: 0.45333rem;\n        display: table-cell;\n        vertical-align: middle; }\n  .goods .foods-wrapper {\n    flex: 1;\n    -webkit-flex: 1;\n    overflow: scroll;\n    -webkit-overflow-scrolling: touch; }\n    .goods .foods-wrapper .foods-list > li {\n      background-color: #fff;\n      margin: 0.16rem; }\n    .goods .foods-wrapper .foods-list .title {\n      padding: 0.32rem 0;\n      font-size: 0.32rem;\n      text-align: center;\n      color: #000; }\n    .goods .foods-wrapper .foods-list li:first-child ul {\n      border-top: 0.01333rem solid #ECECEC; }\n      .goods .foods-wrapper .foods-list li:first-child ul li {\n        border-right: 0.01333rem solid #ECECEC;\n        border-bottom: 0.01333rem solid #ECECEC; }\n        .goods .foods-wrapper .foods-list li:first-child ul li img {\n          margin-top: 0.13333rem; }\n      .goods .foods-wrapper .foods-list li:first-child ul li:nth-child(3n) {\n        border-right: 0; }\n    .goods .foods-wrapper .foods-list ul {\n      display: flex;\n      display: -webkit-flex;\n      flex-wrap: wrap; }\n    .goods .foods-wrapper .foods-list .foods-item {\n      position: relative;\n      width: 33%;\n      height: 2.13333rem;\n      text-align: center;\n      padding-bottom: 0.26667rem; }\n      .goods .foods-wrapper .foods-list .foods-item img {\n        width: 1.33333rem;\n        height: 1.33333rem;\n        vertical-align: middle; }\n      .goods .foods-wrapper .foods-list .foods-item span {\n        display: block;\n        width: 96%;\n        text-align: center;\n        font-size: 0.32rem;\n        margin: 0 0.08rem;\n        overflow: hidden;\n        text-overflow: ellipsis;\n        white-space: nowrap;\n        position: absolute;\n        bottom: 0.16rem; }\n", ""]);
