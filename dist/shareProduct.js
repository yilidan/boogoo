...
/***/ (function(module, exports, __webpack_require__) {
	...
	var higheruserid = _global2.default.getQueryString("higheruserid");
	    ...
	    methods: {
	        ...
	        godown: function godown() {
	            if (bIsIphoneOs) {
	                ...
	                // });
	                var last = Date.now();
	                var ifrSrc = 'boogoo://open.notitlewebview?' + _global2.default.path + "/page/ProductDetails.html?productid=" + productid;
	                var ifr = document.createElement('iframe');
	                ifr.src = ifrSrc;
	                ifr.style.display = 'none';
	                document.body.appendChild(ifr);
	        ...
	        watchinfo: function watchinfo(val) {
	            ...
	            vm.priceInfo.forEach(function (val) {
	                ...
	                if (SKUString == val.skuid) {
	                    _this2.prices = val.price;
	                    _this2.skuid = val.skuid;
	                    _this2.stock = val.stock;
	                }
	            });
	        },
	            ...
	            if (req.data.code == 1000) {
	                ...
	                */
	                this.arrts.forEach(function (val, index) {
	                    ...
	                    _this5.iscur = (0, _assign2.default)({}, _this5.iscur, attrsId); //实现data响应
	                    _this5.isattrtext = (0, _assign2.default)({}, _this5.isattrtext, attrsText); //实现data响应
	                    if (val.attrValueList.length == 1) {
	                        _this5.actives(val.attrValueList[0].attrname, val.attrid, val.attrValueList[0].attrid);
	                        _this5.confirmClass = val.attrValueList[0];
	                    }
	                });
	                ...
	                if (iscur[key] == "") {
	                    ...
	                    this.arrts.forEach(function (val, index) {
	                        if (attrid == val.attrid) {
	                            _global2.default.toast(_this6, "请选择" + val.attrname);
	                            return false;
	                        }
	                    });
	                    return false;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./shareProduct.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./shareProduct.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
