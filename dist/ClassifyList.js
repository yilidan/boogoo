...
/***/ (function(module, exports, __webpack_require__) {
	...
	var classid = _global2.default.getQueryString("classifyId"),
	    categoryid = _global2.default.getQueryString("categoryid");
	var brandid = _global2.default.getQueryString("brandid") ? _global2.default.getQueryString("brandid") : "";
	...
	var vm = new Vue({
	    ...
	    mounted: function mounted() {
	        ...
	        this.$nextTick(function () {
	            ...
	            var hotWordHeight = (0, _jquery2.default)("#hotWord").height();
	            console.log(hotWordHeight);
	            console.log(titleTop);
	            (0, _jquery2.default)(".banner").css({
	                "margin-top": searchH
	            });
	            (0, _jquery2.default)(window).scroll(function () {
	                if ((0, _jquery2.default)(window).scrollTop() >= titleTop) {
	                    (0, _jquery2.default)("#hotWord").css({
	                        'position': "fixed",
	                        'top': searchH - 1,
	                        'left': 0,
	                        'z-index': 200
	                    ...
	                    (0, _jquery2.default)("#loadMore").css({
	    ...
	    methods: {
	        blist: function blist() {
	            ...
	            _axios2.default.get(_global2.default.Apipath + "/api/Product/HeadBanner").then(function (req) {
	                var data = req.data;
	                _this2.bannerList = data.bannerlist;
	        ...
	        // 不同状态排列
	        activeAlign: function activeAlign(status) {
	            this.pageindex = 1;
	        ...
	        active: function active(index, brandid) {
	            //分类点击事件
	        ...
	        cacheData: function cacheData(index, brandid) {
	            /**
	        ...
	        getlistdata: function getlistdata(isloadUp) {
	            var _this3 = this;

	            //获取商品列表
	            _axios2.default.get(_global2.default.Apipath + "/api/Product/ProductSortList", {
	                params: {
	                    token: token,
	                    userid: userid,
	                    classid: classid,
	        ...
	        queryScreenCon: function queryScreenCon() {
	            var _this4 = this;

	            _axios2.default.get(_global2.default.Apipath + "/api/Product/BrandByClassId", {
	                params: {
	                    classid: classid,
	                    categoryid: categoryid
	                }
	                ...
	                var data = req.data;
	                _this4.brandScreenList = data.data;
	                console.log(_this4.brandScreenList);
	            }, function (err) {});
	        },
	        screenSelectBtn: function screenSelectBtn(sBrandid, index) {
	            this.pageindex = 1;
	            if (sBrandid == "all") {
	        ...
	        GoProductDetails: function GoProductDetails(productId) {
	        ...
	        // 滚动吸顶效果
	        scrollCeil: function scrollCeil() {}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./ClassifyList.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./ClassifyList.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
