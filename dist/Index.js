...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _betterScroll = __webpack_require__(117);
	...
	var _searchBar = __webpack_require__(123);
	...
	var _loadTopMore = __webpack_require__(128);

	var _loadTopMore2 = _interopRequireDefault(_loadTopMore);
	...
	var headshow = _global2.default.getQueryString("headshow") ? _global2.default.getQueryString("headshow") : "";
	...
	var vm = new Vue({
	    el: "#app",
	    components: {
	        Youlike: _Youlike2.default, searchBar: _searchBar2.default, loadmores: _loadTopMore2.default, search: _search2.default
	    },
	    data: {
	        swiperSlides: "",
	        navs: "", //分类
	    ...
	    mounted: function mounted() {
	        ...
	        this.$nextTick(function () {
	            if (_this2.headshow == 1) {
	                var searchH = (0, _jquery2.default)(".headerBar").outerHeight();
	    ...
	    computed: {
	        fistProduct: function fistProduct() {
	            return this.product.filter(function (element) {
	                return element.type == 1;
	            });
	        },
	        secondProduct: function secondProduct() {
	            return this.product.filter(function (element) {
	                return element.type == 2;
	            });
	        },
	        thirdProduct: function thirdProduct() {
	            return this.product.filter(function (element) {
	    ...
	    methods: {
	        ...
	        _initScroll: function _initScroll() {
	            var a1 = (0, _jquery2.default)(window).height();
	            // a1 = a1-parseInt("100");
	            (0, _jquery2.default)(".main").height(a1);
	            console.log(a1);
	            this.mainWrapper = new _betterScroll2.default(this.$refs.mainWrapper, {
	                click: true,
	                scrollY: true
	            });
	        },
	        ...
	        getdata: function getdata() {
	            ...
	            _axios2.default.get(_global2.default.Apipath + "/api/Product/HomePage").then(function (req) {
	                var data = req.data;
	                _this3.navs = data.classlist.slice(0, 10); //分类列表
	                _this3.themes = data.brandlist; //品牌列表
	                _this3.product = data.prolist;
	                _this3.swiperSlides = data.bannerlist;
	                _this3.adlist = data.adlist;
	        ...
	        GoClassifyList: function GoClassifyList(id) {
	            if (id === '1') {
	                //品牌
	                var data = (0, _stringify2.default)({
	                    url: _global2.default.path + "/page/brandClass.html?classifyid=" + id
	                });
	                ...
	                //分类
	                var data = (0, _stringify2.default)({
	                    url: _global2.default.path + "/page/goodsClass.html?classifyid=" + id
	                });
	                location.href = "boogoo.app://?pushcode=100011&data=" + data;
	        ...
	        GoClassifyTheme: function GoClassifyTheme(brandid) {
	            var data = (0, _stringify2.default)({
	                url: _global2.default.path + "/page/ClassifyList.html?brandid=" + brandid
	            });
	            location.href = "boogoo.app://?pushcode=100011&data=" + data;
	            // location.href = "./ClassifyList.html?brandid=" + brandid
	        },
	        GoProductDetails: function GoProductDetails(id) {
	            var data = (0, _stringify2.default)({
	                url: _global2.default.path + "/page/ProductDetails.html?productid=" + id
	            });
	            location.href = "boogoo.app://?pushcode=100011&data=" + data;
	        ...
	        // },
	        bannerhandle: function bannerhandle(link) {
	            var data = (0, _stringify2.default)({
	                url: link
	            });
	            location.href = "boogoo.app://?pushcode=100011&data=" + data;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "E:\\Share_Online\\boogouH5\\src\\components\\search.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/style-rewriter.js?id=_v-00716b3c&file=search.vue!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/selector.js?type=style&index=0!./search.vue", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/style-rewriter.js?id=_v-00716b3c&file=search.vue!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/selector.js?type=style&index=0!./search.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    mounted: function mounted() {
	        ...
	        this.$nextTick(function () {
	            if (_global2.default.bIsIphoneOs()) {
	                ...
	                _this.$refs.searchTop.style.paddingTop = "5%";
	            }
	        });
	    },
	    methods: {
	        ...
	        // 扫一扫
	        richScan: function richScan() {
	            var data = (0, _stringify2.default)({
	                type: 0
	            });
	            location.href = "boogoo.app://?pushcode=100010";
	        }
	    ...
	    //         margin:0 auto;
	    //         background-color: rgba(213, 213, 213,.42);
	    //         border-radius: .1rem;
	    //         vertical-align:middle;
	    //         .icon-icon19{
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\Share_Online\\boogouH5\\src\\components\\searchBar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/style-rewriter.js?id=_v-368e6101&file=searchBar.vue!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/selector.js?type=style&index=0!./searchBar.vue", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/style-rewriter.js?id=_v-368e6101&file=searchBar.vue!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/selector.js?type=style&index=0!./searchBar.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".searchBoxhome {\n  display: inline-block;\n  width: 90%;\n  height: 0.8rem;\n  line-height: 0.8rem;\n  margin: 0 auto;\n  background-color: rgba(213, 213, 213, 0.42);\n  border-radius: .1rem;\n  vertical-align: middle; }\n  .searchBoxhome .icon-icon19 {\n    font-size: 0.42667rem;\n    float: left;\n    margin-left: 0.13333rem;\n    color: #999; }\n  .searchBoxhome .icon-scan1 {\n    font-size: 0.42667rem;\n    float: right;\n    margin-right: 0.13333rem;\n    color: #999; }\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// <template lang="html">
	//     <div class="searchBoxhome" @click="Gosearch">
	//         <i class="iconfont icon-icon19"></i>
	//         <i class="iconfont icon-scan1" @click.stop="richScan"></i>
	//     </div>
	// </template>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\Share_Online\\boogouH5\\src\\components\\loadTopMore.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/style-rewriter.js?id=_v-0e04723a&file=loadTopMore.vue!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/selector.js?type=style&index=0!./loadTopMore.vue", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/style-rewriter.js?id=_v-0e04723a&file=loadTopMore.vue!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_vue-loader@7.5.3@vue-loader/lib/selector.js?type=style&index=0!./loadTopMore.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = "\r\n      <mt-loadmore v-on:bottom-status-change=\"handleTopChange\" :bottom-distance=\"100\" :bottom-method=\"loadBottom\" v-on:top-status-change=\"handleTopChange2\" :top-distance=\"120\" :top-method=\"loadTop\" ref=\"loadmore\">\r\n          <slot>\r\n          </slot>\r\n          <div slot=\"bottom\" class=\"mint-loadmore-bottom\">\r\n               <span v-show=\"bottomStatus === 'loading'\">加载中...</span>\r\n                <span v-show=\"bottomStatus !== 'loading'\">\r\n                    <div v-if=\"bottom\">- 已经到底了哦 -</div>\r\n                    <div v-else><img src=\"" + __webpack_require__(68) + "\" alt=\"\"><span>上滑加载更多</span></div>\r\n                </span>\r\n            </div>\r\n            <div slot=\"top\" class=\"mint-loadmore-top\">\r\n                 <span v-show=\"topStatus === 'loading'\">\r\n                     <mt-spinner type=\"snake\"></mt-spinner>\r\n                 </span>\r\n                  <span v-show=\"topStatus !== 'loading'\">\r\n                      <!-- <div v-if=\"top\">- 已经到底了哦 -</div> -->\r\n                      <div>\r\n                          <img src=\"" + __webpack_require__(133) + "\" alt=\"\">\r\n                          <span>下拉刷新</span>\r\n                      </div>\r\n                  </span>\r\n            </div>\r\n     </mt-loadmore>\r\n";

/***/ }),
/* 133 */
/***/ (function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./Index.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./Index.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
