...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _iosSelect = __webpack_require__(39);
	...
	var vm = new Vue({
	    ...
	    methods: {
	        selectSite: function selectSite() {
	            //选择城市
	            var _this = this;
	            var showContactDom = (0, _jquery2.default)('#show_contact');
	            var oneLevelId = showContactDom.attr('data-province-code');
	            var twoLevelId = showContactDom.attr('data-city-code');
	            var sanguoSelect = new _iosSelect2.default(2, [iosProvinceS, iosCityS], {
	                relation: [1, 0, 0, 0],
	                itemShowCount: 5,
	                itemHeight: 1.2,
	                headerHeight: 0.8,
	            ...
	            (0, _jquery2.default)(".layer").animate({
	                bottom: "0px"
	            }, 200);
	        },
	            ...
	            if (this.site == "" || this.DetailedSite == "" || this.consignee == "" || this.Phone == "") {
	                ...
	                _axios2.default.get(_global2.default.Apipath + "/api/Product/EditAddress", {
	                    ...
	                    if (data.code == 1000) {
	                        ...
	                        _global2.default.toast(_this3, "保存失败");
	                    }
	                }, function (err) {
	                    alert("EditAddress err");
	                });
	        ...
	        getcity: function getcity() {
	            _axios2.default.get(_global2.default.Apipath + "/api/Product/AreaInfo", {
	                params: {
	                    token: token,
	                    userid: userid
	                }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../_css-loader@0.23.1@css-loader/index.js!!./iosSelect.css", function() {
				var newContent = require("!!../../_css-loader@0.23.1@css-loader/index.js!!./iosSelect.css");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./EditSite.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./EditSite.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
