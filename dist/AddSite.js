	    ...
	    methods: {
	        ...
	        AddSite: function AddSite() {
	            if (this.site == "" || this.DetailedSite == "" || this.consignee == "" || this.Phone == "") {
	                _global2.default.toast(this, "请填写完整");
	                return false;
	            } else if (!/^1(3|4|5|7|8)\d{9}$/.test(this.Phone)) {
	                _global2.default.toast(this, "号码格式不正确");
	                return false;
	            } else {
	                _axios2.default.post(_global2.default.Apipath + "/api/Product/EditAddress", _qs2.default.stringify({
	                    token: token,
	                    userid: userid,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./AddSite.scss", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./AddSite.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
